...
\textbf{Question}: Implement a function that sums up all multiples of $3$ or $5$ in a list.
...
\textbf{Original Question:} The first six prime numbers are $2, 3, 5, 7, 11, 13$. We can see that the $6$th prime number is $13$. 

What is the $10001$th prime number?

\vspace{1.0cm}

\textbf{Solution:} We will attempt to solve this problem in two steps, starting with a random guess of $500000$:
\begin{enumerate}
...
\item \textbf{Solution part (a)}: What is the $10001$th prime number between $2$ and $500000$?
...
\textbf{Original Question:} The prime factors of $13195$ are $5, 7, 13, 29$. 

What is the largest prime factor of the number $600851475143$?

\vspace{0.5cm} 

Observation: $\sqrt{600851475143} = 775146.099\ldots \approx 775146$. We will use this number $775146$ in modifying our original question:

\textbf{Modified Question:} Within the range from $2$ until $775146$, which is the $\ldots$
\begin{itemize}
\item $\ldots$ largest $\ldots$
\item $\ldots$ prime number $\ldots$
\item $\ldots$ that can divide $600851475143$?
\end{itemize}
